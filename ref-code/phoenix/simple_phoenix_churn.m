function [out_host, in_host] = simple_phoenix_churn(D, dim, N, K, C, num_round, round_length, mean_on_length)
...
% Init_alive_percentage = 0.8;
% XXX all hosts will always be up
Init_alive_percentage = 1.01;
...
current_time = 0;
%time_bound = 3600*3;
% XXX we proceed 150 rounds

time_bound = num_round * round_length;
evolution_npre = [];
